...
int main(int argc, char const *argv[])
{
    ...
    if (accepted == all)
    {
          std::cout << "Проверка пройдена, все значения соответсвуют действительности" << std::endl;
    }
    else
    {
        std::cout << "Значения не соответвуют, проверка не пройдена"<< std::endl;
    }
